...
class AddrIdentifierIndex(GlobalSecondaryIndex):
    ...
    class Meta:
        index_name = "addr_identifier_index"
...
class BtcAddresses(Model):
    ...
    neighbor_addrs = NumberSetAttribute(default=set([]))
    used_as_input = NumberSetAttribute(default=set([]))
    used_as_output = NumberSetAttribute(default=set([]))
